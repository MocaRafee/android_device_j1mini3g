 ...
 * {@hide}
 */
public class SamsungGJ1MRIL extends SamsungSPRDRIL implements CommandsInterface {

    public SamsungGJ1MRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public SamsungGJ1MRIL(Context context, int preferredNetworkType,
